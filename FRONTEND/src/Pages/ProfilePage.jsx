...
import {Edit, UserPlus, UserMinus, AlertCircle, BookOpen, FileText, Image, Hexagon} from "lucide-react";
        ...
        <>
            {isOwner ? (
                <motion.button
                    ...
                    className="p-2 bg-black text-yellow-400 rounded-full hover:bg-gray-700 transition-colors cursor-pointer"
                ...
                <motion.button
                    ...
                    className={`flex items-center space-x-1 px-3 py-2 rounded-lg font-medium cursor-pointer ${
                        isFollowing
